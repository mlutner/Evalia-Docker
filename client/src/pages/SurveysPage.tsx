                  ...
                  <div key={survey.id} className="relative">
                    <SurveyCard
                      survey={{
                        ...
                        createdAt: new Date(survey.createdAt).toString(),
                        questionCount: survey.questions.length,
                        responseCount: survey.responseCount,
                        status: survey.status ?? undefined,
                        publishedAt: survey.publishedAt ? new Date(survey.publishedAt).toString() : undefined,
                        trainerName: survey.trainerName ?? undefined,
                        trainingDate: survey.trainingDate ? new Date(survey.trainingDate).toString() : undefined,
