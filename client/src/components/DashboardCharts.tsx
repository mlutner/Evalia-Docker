  ...
  return (
    <ResponsiveContainer width="100%" height={250}>
      <LineChart data={data}>
        ...
        />
        <Line type="monotone" dataKey="responses" stroke="#3A8DFF" strokeWidth={2} dot={{ fill: "#3A8DFF", r: 4, style: { fill: "#3A8DFF" } }} isAnimationActive={false} />
      </LineChart>
    </ResponsiveContainer>
  );
}
  ...
  return (
    <ResponsiveContainer width="100%" height={250}>
      <BarChart data={data}>
        ...
        />
        <Bar dataKey="count" fill="#3A8DFF" isAnimationActive={false} shape={{ style: { fill: "#3A8DFF" } }} />
      </BarChart>
    </ResponsiveContainer>
  );
}
  ...
  return (
    <ResponsiveContainer width="100%" height={250}>
      <BarChart data={data}>
        ...
        />
        <Bar dataKey="responses" fill="#3A8DFF" isAnimationActive={false} shape={{ style: { fill: "#3A8DFF" } }} />
      </BarChart>
    </ResponsiveContainer>
  );
}
