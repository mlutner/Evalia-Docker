    ...
    >
      ...
      <div className="px-5 pt-4 pb-2">
        <div className="flex items-start justify-between gap-3">
          ...
          <Badge variant="outline" style={{ backgroundColor: 'rgba(47, 143, 165, 0.08)', color: '#2F8FA5', borderColor: 'rgba(47, 143, 165, 0.3)', fontSize: '11px', padding: '4px 8px' }} className="gap-1 flex-shrink-0" data-testid={`badge-question-count-${template.id}`}>
